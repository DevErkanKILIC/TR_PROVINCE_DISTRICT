CREATE DATABASE TR_PROVINCE_DISTRICT
USE TR_PROVINCE_DISTRICT
...
(
	...
	ProvinceID TINYINT FOREIGN KEY(ProvinceID) REFERENCES Provinces(ID) NOT NULL,
	[Name] VARCHAR(50) NOT NULL
)
...
SELECT * FROM Districts ORDER BY ProvinceID ASC